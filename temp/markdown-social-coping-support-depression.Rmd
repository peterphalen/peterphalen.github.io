...
The ISEL-Tangible subscale is intended to capture "perceived availability of material aid." If anything it predicts *increased* risk of suicidal ideation in our sample, after controlling for the other variables in the model. The Tangible subscale consists of the following 10 items:
...
It's hard to understand how items like these could predict increased suicidality even after controlling for other items in the model. (If you remove the other COPE and ISEL variables from the model, ISEL-Tangible predicts decreased suicidality as you would expect.)  
